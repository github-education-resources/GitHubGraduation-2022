...
Replace `kedarabhyankar` with your GitHub username in this guide.

### First, create the folder _data/kedarabhyankar 
Fork this repository, create a new folder inside the `_data` folder, and name it with your username. It should look something like this `_data/kedarabhyankar`. Ex.
